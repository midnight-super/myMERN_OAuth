...
const PopUpOptionalButton = () => {
  const [selected, setSelected] = useState("Delete");
        ...
        /> */}
          <span
            className={`font-medium pr-2 ${
              selected === "Delete" ? "text-gray-900" : "text-gray-500"
            }`}
          >
            Mixiflow
          </span>
...
export default PopUpOptionalButton;
